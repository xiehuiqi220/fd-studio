export default {
  ...
  'menu.home': '首頁',
  'menu.project.detail': '項目概況',
  'menu.project.edit': '修改項目',
  'menu.project.list': '項目列表',
  'menu.project.create': '創建項目',
  'menu.storyboard.edit': '編輯分鏡',
  'menu.script.create': '創建劇本',
  'menu.script.editor': '編輯劇本',
  'menu.location.manage': '場景',
  'menu.role.manage': '角色',
  'menu.login': '登錄',
  'menu.register': '註冊',
